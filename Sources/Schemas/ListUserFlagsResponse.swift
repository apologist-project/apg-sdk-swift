...
public struct ListUserFlagsResponse: Codable, Hashable, Sendable {
    public let data: [UserFlag]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent([UserFlag].self, forKey: .data)
