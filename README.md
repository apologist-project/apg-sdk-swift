...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=ApologistAi%2FSwift)
...
```swift
dependencies: [
    .package(url: "https://github.com/apologist-project/apg-sdk-swift", from: "0.0.1"),
]
```
